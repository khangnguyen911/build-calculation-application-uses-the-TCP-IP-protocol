...
public class ChuViHinhBinhHanh extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "chuViHinhBinhHanh";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChuViHinhBinhHanh frame = new ChuViHinhBinhHanh();
	 ...
	 * Create the frame.
	 */
	public ChuViHinhBinhHanh() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChuViHinhBinhHanh.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Chu vi hinh Binh hanh");
		...
		JLabel lblEnt1 = new JLabel("Nhap chieu dai cua hinh binh hanh:");
		...
		JLabel lblInf = new JLabel("Chu vi hinh Binh hanh");
		...
		JLabel lblEnt2 = new JLabel("Nhap chieu rong cua hinh binh hanh:");
