...
public class ChuViHinhTron extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "chuViHinhTron";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChuViHinhTron frame = new ChuViHinhTron();
	...
	public ChuViHinhTron() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChuViHinhTron.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Chu vi hinh Tron");
		...
		JLabel lblInf = new JLabel("Chu vi hinh Tron");
