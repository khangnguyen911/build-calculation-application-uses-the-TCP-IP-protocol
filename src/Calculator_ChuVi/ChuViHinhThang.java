...
public class ChuViHinhThang extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "chuViHinhThang";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChuViHinhThang frame = new ChuViHinhThang();
	 ...
	 * Create the frame.
	 */
	public ChuViHinhThang() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChuViHinhThang.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Chu vi hinh Thang");
		...
		lblHostname.setBounds(51, 41, 80, 30);
		...
		textFieldHostName.setBounds(152, 41, 150, 30);
		...
		lblPort.setBounds(474, 41, 60, 30);
		...
		textFieldPort.setBounds(544, 41, 81, 30);
		contentPane.add(textFieldPort);

		JLabel lblEnt1 = new JLabel("Nhap canh thu nhat cua hinh Thang:");
		...
		lblEnt1.setBounds(51, 143, 276, 30);
		...
		txt1st.setBounds(344, 143, 190, 30);
		...
		btnReturnToMenu.setBounds(441, 359, 182, 30);
		...
		btnClickHereTo.setBounds(258, 82, 215, 50);
		contentPane.add(btnClickHereTo);
		
		JLabel lblInf = new JLabel("Chu vi hinh Thang");
		...
		JLabel lblEnt2 = new JLabel("Nhap canh thu hai cua hinh Thang:");
		...
		lblEnt2.setBounds(51, 196, 276, 30);
		...
		txt2nd.setBounds(344, 196, 190, 30);
		contentPane.add(txt2nd);
		
		JLabel lblEnt3 = new JLabel("Nhap canh thu ba cua hinh Thang:");
		...
		lblEnt3.setBounds(51, 248, 276, 30);
		...
		txt3rd.setBounds(344, 248, 190, 30);
		contentPane.add(txt3rd);
		
		JLabel lblEnt4 = new JLabel("Nhap canh thu tu cua hinh Thang:");
		...
		lblEnt4.setBounds(51, 301, 276, 30);
		...
		txt4th.setBounds(344, 301, 190, 30);
