...
public class ChuViHinhVuong extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "chuViHinhVuong";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChuViHinhVuong frame = new ChuViHinhVuong();
	...
	public ChuViHinhVuong() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChuViHinhVuong.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Chu vi hinh Vuong");
		...
		JLabel lblInf = new JLabel("Chu vi hinh Vuong");
