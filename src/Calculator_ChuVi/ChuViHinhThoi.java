...
public class ChuViHinhThoi extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "chuViHinhThoi";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChuViHinhThoi frame = new ChuViHinhThoi();
	 ...
	 * Create the frame.
	 */
	public ChuViHinhThoi() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChuViHinhThoi.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Chu vi hinh Thoi");
		...
		JLabel lblEnt1 = new JLabel("Nhap canh cua hinh thoi:");
		...
		JLabel lblInf = new JLabel("Chu vi hinh Thoi");
