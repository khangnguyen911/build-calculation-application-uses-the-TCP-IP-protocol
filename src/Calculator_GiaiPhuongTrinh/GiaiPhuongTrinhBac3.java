...
public class GiaiPhuongTrinhBac3 extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "phuongTrinhBac3";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GiaiPhuongTrinhBac3 frame = new GiaiPhuongTrinhBac3();
	...
	public GiaiPhuongTrinhBac3() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GiaiPhuongTrinhBac3.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Giai phuong trinh bac 3");
		...
		JLabel lblInf = new JLabel("Giai phuong trinh bac 3 co dang ax^3 + bx^2 + cx + d = 0");
		...
		JLabel lblEnt4 = new JLabel("Nhap d:");
