...
//	static Socket socket;
	...
	private String operator = "phuongTrinhBac1";
	...
	public GiaiPhuongTrinhBac1() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GiaiPhuongTrinhBac1.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		...
		btnClickHereTo.setBounds(408, 163, 215, 50);
		...
		JLabel lblInf = new JLabel("Giai Phuong trinh Bac 1 co dang ax + b = 0");
