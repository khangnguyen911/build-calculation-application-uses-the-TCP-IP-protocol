...
public class PhepTinh3So extends JFrame {
...
//	static Socket socket;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PhepTinh3So frame = new PhepTinh3So();
	 ...
	 */
	public PhepTinh3So() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PhepTinh3So.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Phep tinh co ban voi 3 so");
		...
		rdbtnCong.setBounds(133, 241, 95, 30);
		...
		rdbtnTru.setBounds(326, 241, 95, 30);
		...
		rdbtnNhan.setBounds(232, 285, 95, 30);
		...
		JLabel lblInf = new JLabel("Cong, tru, nhan voi 3 so");
