...
public class DienTichHinhThang extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "dienTichHinhThang";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhThang frame = new DienTichHinhThang();
	 ...
	 * Create the frame.
	 */
	public DienTichHinhThang() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhThang.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Thang");
		...
		JLabel lblEnt1 = new JLabel("Nhap canh day thu nhat cua hinh Thang:");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Thang");
		...
		JLabel lblEnt2 = new JLabel("Nhap canh day thu hai cua hinh Thang:");
		...
		JLabel lblEnt3 = new JLabel("Nhap chieu cao cua hinh Thang:");
