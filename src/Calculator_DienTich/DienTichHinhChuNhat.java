...
//	static Socket socket;
	...
	private String operator = "dienTichHinhChuNhat";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhChuNhat frame = new DienTichHinhChuNhat();
	...
	public DienTichHinhChuNhat() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhChuNhat.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Chu nhat");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Chu nhat");
