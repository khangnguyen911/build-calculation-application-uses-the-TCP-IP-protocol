...
public class DienTichHinhTamGiac extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "dienTichHinhTamGiac";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhTamGiac frame = new DienTichHinhTamGiac();
	 ...
	 * Create the frame.
	 */
	public DienTichHinhTamGiac() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhTamGiac.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Tam giac");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Tam giac");
