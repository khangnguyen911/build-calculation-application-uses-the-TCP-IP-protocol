...
public class DienTichHinhBinhHanh extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "dienTichHinhBinhHanh";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhBinhHanh frame = new DienTichHinhBinhHanh();
	 ...
	 * Create the frame.
	 */
	public DienTichHinhBinhHanh() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhBinhHanh.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Binh hanh");
		...
		JLabel lblEnt1 = new JLabel("Nhap canh day cua hinh binh hanh:");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Binh hanh");
		...
		JLabel lblEnt2 = new JLabel("Nhap chieu cao cua hinh binh hanh:");
