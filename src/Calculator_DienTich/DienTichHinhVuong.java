...
public class DienTichHinhVuong extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "dienTichHinhVuong";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhVuong frame = new DienTichHinhVuong();
	 ...
	 * Create the frame.
	 */
	public DienTichHinhVuong() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhVuong.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Vuong");
		...
		JLabel lblEnt1 = new JLabel("Nhap canh cua hinh vuong:");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Vuong");
