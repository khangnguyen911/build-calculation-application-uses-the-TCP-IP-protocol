...
public class DienTichHinhThoi extends JFrame {
...
//	static Socket socket;
	...
	private String operator = "dienTichHinhThoi";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DienTichHinhThoi frame = new DienTichHinhThoi();
	 ...
	 * Create the frame.
	 */
	public DienTichHinhThoi() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DienTichHinhThoi.class.getResource("/ImageAndLogo/T\u0110T_logo.png")));
		setTitle("Dien tich hinh Thoi");
		...
		JLabel lblEnt1 = new JLabel("Nhap duong cheo thu nhat cua hinh thoi:");
		...
		JLabel lblInf = new JLabel("Dien tich hinh Thoi");
		...
		JLabel lblEnt2 = new JLabel("Nhap duong cheo thu hai cua hinh thoi:");
